       ...
       <div id="navig_bar" class="navbar">
                <ul >
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      ...
                      <%--   <li><input id="signinbutton" style="display:none;color:white;" type="button" class="btn btn-link" >Sign in/Sign Up</li>
          ...
          <div class="col-md-3">
             ...
             <footer >
                 ...
                 <div class="container " style="padding:10px" >
                     ...
                     <div>
                          <form action="feedback.jsp" class="form-control" style="padding:10px">
                     
                     
                     <input name="email" type="text" placeholder="Email Id">
                     <input type="text" name="type" placeholder="Feedback Type"><br>
                     <textarea rows="5" cols="50" name="feedback" >Type here.... </textarea>
                     <br>
                     <input type="submit">
