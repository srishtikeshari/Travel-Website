...
<html>
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <tr><td></td>
                ...
                <td><input type="submit" name="login" value="Login"></td>
                                 ...
                                 <input type="hidden" name="pageurl" value="hotels">
                             </form>
            <br/>
    ...
    <center>   <h1>Search Hotels</h1></center>
     
            <div class="conatainer"> 
                <div class="form-group">
                    <center>  <div class="col-md-4">
        <form action="hotels_info.jsp" method="GET" onsubmit="return valid();">
            <label>Enter the city</label>
            <div class="input-group" placeholder="city" id="city">
            <input class="form-control" type="text" name="city">
            </div>
             <label>Enter Date</label>
            <div class="input-group" placeholder="Date" id="date">
            <input class="form-control" type="date">
            </div> 
             </br>
             <center>    <input class="btn btn-success" type="submit" value="Check Hotels"></center>
